...
- **CRUD Operations:** Implements Create, Read, Update, and Delete for users, books, and reservations by making HTTP requests to the REST API.
...
- **Form Handling:** Handles form submissions for login, registration, and adding new books.
...
- `admin.html`: Admin dashboard with tables for users, books, and reservations.
- `usuario.html`: User dashboard with available books and reservation history.
- `formAgregar.html`: Form for adding new books.
